...
This installs the packages listed in `package.json` under `tests/examples/external-node-runtime/node_modules`.
...
- `httprunner` automatically adds `tests/examples/external-node-runtime/node_modules` to the worker's
